...
class PredictionService:
            ...
            with get_db_connection() as conn:
                ...
                for row in cursor.fetchall():
                    records.append({
                        ...
                        "error_magnitude": abs(row["predicted_value"] - row["actual_value"])
                    })
    ...
    def calculate_accuracy_trends(self, user_email: str, 
        ...
        try:
            ...
            with get_db_connection() as conn:
                ...
                return {
                    "trend": trend,
                    "recent_average_accuracy": sum(recent_accuracy) / len(recent_accuracy) if recent_accuracy else 0,
                    "older_average_accuracy": sum(older_accuracy) / len(older_accuracy) if older_accuracy else 0,
                    "total_predictions": sum(row["predictions_count"] for row in daily_accuracy),
    ...
    def get_prediction_type_performance(self, user_email: str) -> Dict[str, Dict[str, Any]]:
        """
